...
export const LOCATIONS: Location[] = [
  ...
  { id: 'capital', state: 'Caracas (Capital y La Guaira)', address: 'Av. Universidad, Esquina De San Francisco, Centro Mercantil San Francisco, Piso 5, Parroquia Catedral, Dist. Capital.' },
  { id: 'taquilla_unica_caracas', state: 'Caracas (Instituto Nacional de Prevención, Salud y Seguridad Laboral)', address: 'Av. Este 6 Bis, Caracas 1010, Distrito Capital, Venezuela' },
