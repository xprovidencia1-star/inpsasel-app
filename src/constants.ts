...
export const LOCATIONS: Location[] = [
  ...
  { id: 'taquilla_unica_caracas', state: 'Instituto Nacional de Prevención, Salud y Seguridad Laboral', address: 'Av. Este 6 Bis, Caracas 1010, Distrito Capital, Venezuela' },
