...
export const LOCATIONS: Location[] = [
  ...
  { id: 'capital', state: 'Caracas (Sede Central INPSASEL)', address: 'Entre las Esquinas Manduca y Ferrenquín, Edificio Luz Garden, Urbanización La Candelaria, Caracas.', phone: '0426.629.66.79', email: 'gerencia.geresatcapital@gmail.com', mapLink: 'https://maps.app.goo.gl/m57uAzUAVNjUmTG26' },
