...
export const LOCATIONS: Location[] = [
  ...
  { id: 'capital', state: 'Caracas (Capital y La Guaira)', address: 'Av. Universidad, Esquina San Francisco Centro Mercantil San Francisco, Piso 5, Parroquia Capital, Distrito Capital', phone: '0426.629.66.79', email: 'gerencia.geresatcapital@gmail.com', mapLink: createMapLink('Esquina San Francisco Centro Mercantil San Francisco, Caracas, Distrito Capital, Venezuela') },
